...
public class PeakFinder {
	...
	private Roi roi_;
	private SubPixelLocalization refiner_;
	 ...
	 */
	public void setRefiner(SubPixelLocalization refiner) {
		refiner_ = refiner;
	}
	...
	public short refineMaxima() {
		if (refiner_ == null ) {
			...
			case 0:
				refiner_ = new NullSPL();
				break;
			case 1: 
				refiner_ = new PFGWSPL();
				break;
			case 2:
				refiner_ = new GaussianSPL();
				break;
			case 3:
				refiner_ = new NelderMeadSPL(true);
				break;
			}
		}
