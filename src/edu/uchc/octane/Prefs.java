...
public class Prefs {
	...
	public static boolean virtualStack_ = true;
	public static int dicXOffset_ = -9;
	public static int dicYOffset_ = 0;
	public static int ballRadius_ = 50;
	public static boolean pointIndicator_ = true;
	public static boolean showOverlay_ = true;
	public static boolean omitSingleFrameTrajs_ = false;
	public static double palmScaleFactor_ = 10.0;
	public static double palmPSDWidth_ = 0.1875;
	public static int maxPeakArea_ = 300;
	public static double trackerMaxDsp_ = 5;
	public static int trackerMaxBlinking_ = 0;
	public static double palmThreshold_ = 100; 
	public static boolean refinePeak_ = true;
	public static int refiner_ = 1;
	public static int histogramBins_ = 20;
	public static double confidenceThreshold_ = 0;
	public static int sloppyness_ = 1;
	public static int kernelSize_ = 2;
	public static double sigma_ = 0.94;
	public static int IFSScaleFactor_ = 1;
	public static int peakTolerance_ = 2000;
